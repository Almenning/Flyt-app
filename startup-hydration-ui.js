...
function overlay(){let el=document.querySelector('#flytHydrationGuard');if(el)return el;el=document.createElement('div');el.id='flytHydrationGuard';el.style.cssText='position:fixed;inset:0;z-index:390;background:#fff7f1;display:flex;align-items:center;justify-content:center;padding:24px;color:var(--ink)';el.innerHTML='<div style="text-align:center;max-width:320px"><div class="logo">HverdagsOss</div><div class="ey" style="margin-top:14px">Synkroniserer</div><h2 style="font:500 27px/1.15 Georgia;margin:10px 0 8px">Henter deres HverdagsOss</h2><p class="sub">Oppsett, gjennomføringer og poeng hentes før appen åpnes.</p></div>';document.body.appendChild(el);return el}
