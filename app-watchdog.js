...
function ensureHomeOwnership(){const b=window.FlytBridge,c=document.querySelector('#content');if(b?.getState?.()?.view!=='home')return true;if(window.FlytHomeUI?.version!=='20260830-1105'){loadHome();return false}if(homeMarkupIsModern(c))return true;window.FlytHomeUI.render?.({resetScroll:false});return homeMarkupIsModern(c)}
...
function loadHome(){if(window.FlytHomeUI?.version==='20260830-1105'){ensureHomeOwnership();return}loadScript('./home-ui.js?v=20260830-1105','flyt-home-current-1105',()=>queueMicrotask(ensureHomeOwnership))}
