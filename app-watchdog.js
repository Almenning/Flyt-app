...
window.addEventListener('DOMContentLoaded',()=>{loadModal();loadPlanned();loadDayCompleted();loadCustomCategories();loadRecurrence();loadBeta();keepGuardAlive();setTimeout(rescue,5000)});
