...
window.addEventListener('DOMContentLoaded',()=>{loadLegacyCleanup();loadResponsive();loadHome();loadModal();loadPlanned();loadDayCompleted();loadCustomCategories();loadRecurrence();loadBeta();loadRewardsEditGuard();loadRewardsSummary();loadRewardsUI();loadQuickTemptation();loadSetupNavGuard();loadTaskActionsGuard();keepGuardAlive();setTimeout(rescue,5000)});
