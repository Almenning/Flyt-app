...
function loadResponsive(){if(document.querySelector('#flytResponsiveUi'))return;loadScript('./responsive-ui.js?v=20260825-0002','flyt-responsive')}
function loadHome(){if(window.FlytHomeUI)return;loadScript('./home-ui.js?v=20260824-1945','flyt-home-current')}
function loadRewardsGuard(){if(window.FlytRewardsEditGuard)return;loadScript('./rewards-edit-guard.js?v=20260825-0645','flyt-rewards-edit-guard')}
...
window.addEventListener('DOMContentLoaded',()=>{loadResponsive();loadHome();loadModal();loadPlanned();loadDayCompleted();loadCustomCategories();loadRecurrence();loadBeta();loadRewardsGuard();keepGuardAlive();setTimeout(rescue,5000)});
