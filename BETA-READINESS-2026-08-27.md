...
| Personverninformasjon | 🟢 / 🟡 | `privacy.html` forklarer data, formål, deling, samtykke, EU-lagring, sletting og rettigheter. Full juridisk identitet/kontakt for behandlingsansvarlig må fylles inn før bred distribusjon. |
...
| Passord i beta-UI | 🟢 / 🟡 | Ny bruker må velge minst 10 tegn i beta-grensesnittet. Supabase Leaked Password Protection er fortsatt deaktivert og må slås på manuelt. |
...
- Lagt til offentlig personvernside for betaen.
...
1. **Slå på Supabase Leaked Password Protection** i Auth-innstillingene.
2. **Fyll inn full juridisk kontaktinformasjon** for behandlingsansvarlig i `privacy.html`.
3. **Lag fire disponible testkontoer i to separate husholdninger** og verifiser at husholdning A ikke kan lese eller endre husholdning B. Bruk de samme kontoene til å teste samtykketrekking og permanent sletting ende til ende.
4. Når disse tre punktene er grønne, inviter **3–5 par** først. Utvid til 5–10 par når de første dagene ikke viser data-/synkfeil.
