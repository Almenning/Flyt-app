...
assert.match(index, /sync\.js\?v=20260926-native-keychain1/, 'Nettleseren må hente synklaget med native lifecycle, sikker lagring og eksisterende personvernrettinger');
