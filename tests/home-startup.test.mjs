...
assert.match(home, /const VERSION='20260923-granular-consent1'/, 'Home must expose the current startup version');
...
assert.match(watchdog, /FlytHomeUI\?\.version!=='20260923-granular-consent1'/, 'Watchdog must target the current Home version');
assert.match(watchdog, /home-ui\.js\?v=20260923-granular-consent1/, 'Watchdog must cache-bust the current Home module');
