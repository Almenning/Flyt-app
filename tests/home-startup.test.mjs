...
assert.match(home, /const VERSION='20260902-1800'/, 'Home must expose the current startup version');
...
assert.match(watchdog, /FlytHomeUI\?\.version!=='20260902-1800'/, 'Watchdog must target the current Home version');
assert.match(watchdog, /home-ui\.js\?v=20260902-1800/, 'Watchdog must cache-bust the current Home module');
assert.match(watchdog, /nudge-ui\.js\?v=20260902-1730/, 'Watchdog must load the contextual nudge module');
