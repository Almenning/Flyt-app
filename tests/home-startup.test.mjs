...
assert.match(home, /const VERSION='20260901-2300'/, 'Home must expose the current startup version');
...
assert.match(watchdog, /FlytHomeUI\?\.version!=='20260901-2300'/, 'Watchdog must target the current Home version');
assert.match(watchdog, /home-ui\.js\?v=20260901-2300/, 'Watchdog must cache-bust the current Home module');
