...
assert.match(seen, /const VERSION='20260827-2054'/, 'Sett must expose the active/archive version');
...
assert.match(watchdog, /seen-ui\.js\?v=20260827-2054/, 'Watchdog must cache-bust the current Sett UI');
