...
assert.match(seen, /const VERSION='20260902-1800'/, 'Sett must expose the current communication version');
...
assert.match(watchdog, /seen-ui\.js\?v=20260902-1800/, 'Watchdog must cache-bust the current Sett UI');
