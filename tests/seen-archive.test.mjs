...
assert.match(seen,/Legg til melding/,'oppgavemeldinger bruker samme sheet-system');
assert.match(seen,/seenQuickLinks/,'sekundærhandlinger bruker en rolig felles radkomponent');
assert.match(seen,/Ikke alt som teller blir registrert\./,'tomtilstanden forklarer at uregistrert innsats fortsatt teller');
...
assert.match(watchdog,/seen-ui\.js\?v=20260926-seen-premium1/);
