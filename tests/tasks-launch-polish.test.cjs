...
assert.match(recurrence,/const VERSION='20260926-due-soon2'/);
...
assert.match(watchdog,/recurrence-ui\.js\?v=20260926-due-soon2/,'the watchdog must load the due-soon task UI');
assert.match(index,/recurrence-ui\.js\?v=20260926-due-soon2/,'the initial task UI load must use the due-soon version');
