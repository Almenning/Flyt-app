(()=>{
'use strict';
const RELEASE='20260912-reorderrollback11';
let installed=false;
...
function registerSW(){if(window.FlytPlatform?.isNative||!('serviceWorker'in navigator))return;navigator.serviceWorker.register(`./sw.js?v=${RELEASE}`,{updateViaCache:'none'}).catch(()=>{})}
