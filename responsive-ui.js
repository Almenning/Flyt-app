...
@media(max-width:390px){.content{padding-left:12px;padding-right:12px}.title{font-size:31px}.card{padding:13px}.top{padding-left:9px;padding-right:9px;gap:6px}.pill{padding:9px 11px}.nav button{font-size:12px}.homeStats{gap:6px}}
`;
